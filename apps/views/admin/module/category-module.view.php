...
<div class="padding">
  <div class="box">
  	<!-- start tool table -->
	<form class="navbar-form form-inline pull-right pull-none-sm navbar-item v-m" method="GET" action="<?php echo $baseUrl?>/module/category-module" role="search">
	...
	<div class="navbar-item">
		<a href="<?php echo $baseUrl.'module/form-category'?>" class="btn btn-sm btn-outline b-black text-black margin-left"><?php echo $this->trans->get('add_new')?></a>
	</div>
	<!-- end tool table -->
      ...
      <table class="table table-striped b-t b-b">
        ...
        <tbody>
          ...
          <tr data-id="<?php echo $category->category_id?>">
            <td class="no-wrap">
              <button class="btn btn-sm dark" id="btn-edit" data-target="<?php echo $baseUrl.'module/edit-category/'.$category->category_id?>"><?php echo $this->trans->get('btn_edit')?></button>
