...
<div class="app-body amber bg-auto w-full">
	<div class="text-center pos-rlt p-y-md">
		...
		<p class="h5 m-y-lg text-u-c font-bold text-black"><?php echo $this->trans->get('page_not_exists')?></p>
		<a href="/admin/dashboard" class="md-btn amber-700 md-raised p-x-md">
			<span class="text-white"><?php echo $this->trans->get('go_to_home_page')?></span>
		</a>
	</div>
</div>